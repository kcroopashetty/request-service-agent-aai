...
An AgenicAI based approval management system for employees within organization to raise requests for laptops, desk phones, mobiles, travel requests, expense approval etc..This project aims to streamline approval management process in organizations for accountability & traceability. With RequestServiceAgent, employees can converse naturally with AI Agent and specify the business reason or justification to avail a facility which can be approved by their line managers depending on the hierarchy. The approval flow can also be customized depending on the request made.


## 📘 Project Overview
Request Service Agent development.
...
1. **Navigate to the backend directory**  
   ```bash
   cd /workspace/request_service_agent/backend
   ```
